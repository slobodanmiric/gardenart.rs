...
<div class="jumbotron vertikuliranje-travnjaka">
    <div class="container">
        <h2 class="text-center wow pulse">Vertikuliranje travnjaka </h2>
        <p class="text-center">
...
<div class="container usluge">
    ...
    <div class="row">
        <div class="col-md-4">
            <a href="images/vertikuliranje%20travnjaka%201.jpg" data-lightbox="gallery" data-title="vertikuliranje travnjaka 1"><img src="images/vertikuliranje%20travnjaka%201.jpg" class="img-thumbnail" alt="vertikuliranje travnjaka"></a>
        </div>
        <div class="col-md-4">
           <a href="images/vertikuliranje%20travnjaka%202.jpg" data-lightbox="gallery" data-title="vertikuliranje travnjaka 2"><img src="images/vertikuliranje%20travnjaka%202.jpg" class="img-thumbnail" alt="vertikuliranje travnjaka"></a>
        </div>
        <div class="col-md-4">
           <a href="images/vertikuliranje%20travnjaka%203.jpg" data-lightbox="gallery" data-title="vertikuliranje travnjaka 3"><img src="images/vertikuliranje%20travnjaka%203.jpg" class="img-thumbnail" alt="vertikuliranje travnjaka"></a>
        </div>
    </div>
    <div class="row">
        <div class="col-md-4">
            <a href="images/vertikuliranje%20travnjaka%204.jpg" data-lightbox="gallery" data-title="vertikuliranje travnjaka 4"><img src="images/vertikuliranje%20travnjaka%204.jpg" class="img-thumbnail" alt="vertikuliranje travnjaka"></a>
        </div>
        <div class="col-md-4">
           <a href="images/vertikuliranje%20travnjaka%205.jpg" data-lightbox="gallery" data-title="vertikuliranje travnjaka 5"><img src="images/vertikuliranje%20travnjaka%205.jpg" class="img-thumbnail" alt="vertikuliranje travnjaka"></a>
        </div>
        <div class="col-md-4">
           <a href="images/vertikuliranje%20travnjaka%206.jpg" data-lightbox="gallery" data-title="vertikuliranje travnjaka 6"><img src="images/vertikuliranje%20travnjaka%206.jpg" class="img-thumbnail" alt="vertikuliranje travnjaka"></a>
        </div>
    </div>
