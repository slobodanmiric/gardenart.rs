...
<div class="jumbotron okopavanje-bastice">
    <div class="container">
        <h2 class="text-center wow pulse">Okopavanje baštice</h2>
        <p class="text-center">
...
<div class="container usluge">
    ...
    <div class="row">
        <div class="col-md-6">
            <a href="images/okopavanje%20bastice%203.jpg" data-lightbox="gallery" data-title="okopavanje bastice 1"><img src="images/okopavanje%20bastice%203.jpg" class="img-thumbnail" alt="okopavanje bastice"></a>
        </div>
        <div class="col-md-6">
           <a href="images/okopavanje%20bastice%204.jpg" data-lightbox="gallery" data-title="okopavanje bastice 2"><img src="images/okopavanje%20bastice%204.jpg" class="img-thumbnail" alt="okopavanje bastice"></a>
        </div>
    </div>
    <div class="row">
        <div class="col-md-6">
            <a href="images/okopavanje%20bastice%201.jpg" data-lightbox="gallery" data-title="okopavanje bastice 3"><img src="images/okopavanje%20bastice%201.jpg" class="img-thumbnail" alt="okopavanje bastice"></a>
        </div>
        <div class="col-md-6">
           <a href="images/okopavanje%20bastice%202.jpg" data-lightbox="gallery" data-title="okopavanje bastice 4"><img src="images/okopavanje%20bastice%202.jpg" class="img-thumbnail" alt="okopavanje bastice"></a>
        </div>
    </div>
