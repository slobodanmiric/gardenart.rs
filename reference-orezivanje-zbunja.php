...
<div class="jumbotron orezivanje-zbunja">
    <div class="container">
        <h2 class="text-center wow pulse">Orezivanje žbunja</h2>
        <p class="text-center">
...
<div class="container usluge">
    ...
    <div class="row">
        <div class="col-md-7">
            <div class="row">
                <div class="col-md-6">
                    <a href="images/orezivanje%20zbunja%206.jpg" data-lightbox="gallery" data-title="Orezivanje žbunja 1"><img src="images/orezivanje%20zbunja%206.jpg" class="img-thumbnail" alt="Orezivanje žbunja"></a>
                </div>
                <div class="col-md-6">
                    <a href="images/orezivanje%20zbunja%202.jpg" data-lightbox="gallery" data-title="Orezivanje žbunja 2"><img src="images/orezivanje%20zbunja%202.jpg" class="img-thumbnail" alt="Orezivanje žbunja"></a>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <a href="images/orezivanje%20zbunja%203.jpg" data-lightbox="gallery" data-title="Orezivanje žbunja 3"><img src="images/orezivanje%20zbunja%203.jpg" class="img-thumbnail" alt="Orezivanje žbunja"></a>
                </div>
                <div class="col-md-6">
                    <a href="images/orezivanje%20zbunja%204.jpg" data-lightbox="gallery" data-title="Orezivanje žbunja 4"><img src="images/orezivanje%20zbunja%204.jpg" class="img-thumbnail" alt="Orezivanje žbunja"></a>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <a href="images/orezivanje%20zbunja%205.jpg" data-lightbox="gallery" data-title="Orezivanje žbunja 5"><img src="images/orezivanje%20zbunja%205.jpg" class="img-thumbnail" alt="Orezivanje žbunja"></a>
                </div>
            </div>
        </div>
        <div class="col-md-5">
            <div class="col-md-12">
                <a href="images/orezivanje%20zbunja%201.jpg" data-lightbox="gallery" data-title="Orezivanje žbunja 6"><img src="images/orezivanje%20zbunja%201.jpg" class="img-thumbnail" alt="Orezivanje žbunja"></a>
            </div>
        </div>
    </div>
