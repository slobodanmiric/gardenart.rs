...
<div class="jumbotron usisavanje-ciscenje">
    <div class="container">
        <h2 class="text-center wow pulse">Usisavanje, čišćenje</h2>
        <p class="text-center">
...
<div class="container usluge">
    ...
    <div class="row">
        <div class="col-md-4">
            <a href="images/usisavanje-ciscenje%201.jpg" data-lightbox="gallery" data-title="Usisavanje, čišćenje 1"><img src="images/usisavanje-ciscenje%201.jpg" class="img-thumbnail" alt="Usisavanje, čišćenje"></a>
        </div>
        <div class="col-md-4">
           <a href="images/usisavanje-ciscenje%202.jpg" data-lightbox="gallery" data-title="Usisavanje, čišćenje 2"><img src="images/usisavanje-ciscenje%202.jpg" class="img-thumbnail" alt="Usisavanje, čišćenje"></a>
        </div>
        <div class="col-md-4">
           <a href="images/usisavanje-ciscenje%203.jpg" data-lightbox="gallery" data-title="Usisavanje, čišćenje 3"><img src="images/usisavanje-ciscenje%203.jpg" class="img-thumbnail" alt="Usisavanje, čišćenje"></a>
        </div>
    </div>
