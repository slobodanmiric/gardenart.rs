...
<div class="jumbotron zardinjere-header">
    <div class="container">
        <h2 class="text-center wow pulse">Žardinjere</h2>
        <p class="text-center">
...
<div class="container usluge">
    ...
    <div class="row">
        <div class="col-md-4">
            <a href="images/zardinjere%202.jpg" data-lightbox="gallery" data-title="Žardinjere 1"><img src="images/zardinjere%202.jpg" class="img-thumbnail" alt="Žardinjere"></a>
        </div>
        <div class="col-md-4">
           <a href="images/zardinjere%203.jpg" data-lightbox="gallery" data-title="Žardinjere 2"><img src="images/zardinjere%203.jpg" class="img-thumbnail" alt="Žardinjere"></a>
        </div>
        <div class="col-md-4">
           <a href="images/zardinjere%204.jpg" data-lightbox="gallery" data-title="Žardinjere 3"><img src="images/zardinjere%204.jpg" class="img-thumbnail" alt="Žardinjere"></a>
        </div>
    </div>
    <div class="row">
        <div class="col-md-6">
            <a href="images/zardinjere%201.jpg" data-lightbox="gallery" data-title="Žardinjere 4"><img src="images/zardinjere%201.jpg" class="img-thumbnail" alt="Žardinjere"></a>
        </div>
        <div class="col-md-6">
           <a href="images/zardinjere%205.jpg" data-lightbox="gallery" data-title="Žardinjere 5"><img src="images/zardinjere%205.jpg" class="img-thumbnail" alt="Žardinjere"></a>
        </div>
    </div>
